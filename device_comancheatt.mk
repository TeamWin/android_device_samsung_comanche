...
$(call inherit-product-if-exists, vendor/samsung/comancheatt/comancheatt-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/samsung/comancheatt/overlay

LOCAL_PATH := device/samsung/comancheatt
